...
public class HandsRBT {
    ...
    {
        // This method performs the Leftward Node Rotation
        // don't forget to update children and parent pointers
        HandsRBTNode parent = thisNode.right;
        HandsRBTNode rightChild = parent.left;

        thisNode.right = rightChild;
        if(rightChild != null) {
            rightChild.parent = thisNode;
        }
        
        parent.parent = thisNode.parent;
        if(thisNode.parent == null) {
            root = parent;
        } else if(thisNode == thisNode.parent.left) {
            thisNode.parent.left = parent;
        } else {
            thisNode.parent.right = parent;
        }
    ...
    {
        // This method performs the Rightward Node Rotation
        // don't forget to update children and parent pointers

        HandsRBTNode parent = thisNode.left;
        HandsRBTNode leftChild = parent.right;

        thisNode.left = leftChild;
        if(leftChild != null) {
            leftChild.parent = thisNode;
        }
    ...
    private void fixRedViolation(HandsRBTNode thisNode)
    {
     ...
     // Case 1. Red Uncle. (Here you have to check if the red violation moves up the tree; if so recurse.
     // Case 2. Black Uncle & Outergrandchild
     // Case 3. Black Uncle & Innergrandchild   

        while (thisNode.parent != null && thisNode.parent.colour == RED) {
            HandsRBTNode p = thisNode.parent;
            HandsRBTNode g = p.parent;
    
            if (g == null) break; // To ensure that a value exists
    
            HandsRBTNode uncle = getUncle(p);
    ...
    // Use the generic class Vector<E> in package java.util. See Java API specification
        Vector<HandsRBTNode> nodes = new Vector<HandsRBTNode>();
        inOrderTraversal(root, thisCard, nodes);
    
        for (int i = 0; i < nodes.size(); i++) {
            delete(nodes.get(i).myHand);
        }
    }      
    // Helper function for deleteHandsWithCard, need it for recursive to traverse the RBT 
    private void inOrderTraversal(HandsRBTNode node, Card thisCard, Vector<HandsRBTNode> nodes) {
        if (node == null) {
            return;
        }
        
        // Traverse left subtree
        inOrderTraversal(node.left, thisCard, nodes);
        
        // Check if the current node's hand contains the specified card
        if (node.myHand.hasCard(thisCard)) {
            nodes.add(node);
        }
        
        // Traverse right subtree
        inOrderTraversal(node.right, thisCard, nodes);
    }
    ...
    private static void testCustomInsertCase4()
    {
        ...
        HandsRBT testRBT = new HandsRBT();
        Hands myHandsArray[] = new Hands[5];        
        myHandsArray[0] = new Hands(new Card(7, 'H'), new Card(4, 'D'), new Card(7, 'C'), new Card(7, 'S'), new Card(4, 'H'));
        ...
        myHandsArray[3] = new Hands(new Card(14, 'S'), new Card(13, 'D'), new Card(13, 'C'), new Card(14, 'H'), new Card(14, 'H'));
        myHandsArray[4] = new Hands(new Card(15, 'S'), new Card(7, 'D'), new Card(7, 'C'), new Card(15, 'H'), new Card(15, 'H'));
        testRBT.insert(myHandsArray[0]);
        testRBT.insert(myHandsArray[1]);
        testRBT.insert(myHandsArray[2]);
        testRBT.insert(myHandsArray[3]); // this will trigger Case 3
    ...
    private static void testCustomInsertCase5()
    {
        ...
        HandsRBT testRBT = new HandsRBT();
        Hands myHandsArray[] = new Hands[5];        
        myHandsArray[0] = new Hands(new Card(9, 'H'), new Card(5, 'D'), new Card(9, 'C'), new Card(9, 'S'), new Card(5, 'H'));
        myHandsArray[1] = new Hands(new Card(9, 'D'), new Card(9, 'S'), new Card(5, 'H'), new Card(9, 'C'), new Card(9, 'H'));
        myHandsArray[2] = new Hands(new Card(5, 'H'), new Card(7, 'D'), new Card(6, 'C'), new Card(9, 'H'), new Card(4, 'S'));
        myHandsArray[3] = new Hands(new Card(10, 'S'), new Card(10, 'D'), new Card(10, 'C'), new Card(10, 'H'), new Card(8, 'H'));
        myHandsArray[4] = new Hands(new Card(11, 'S'), new Card(9, 'D'), new Card(9, 'C'), new Card(11, 'H'), new Card(11, 'H'));
        testRBT.insert(myHandsArray[0]);
        testRBT.insert(myHandsArray[1]);
        testRBT.insert(myHandsArray[2]);
        testRBT.insert(myHandsArray[3]); // this will trigger Case 3
    ...
    private static void testCustomDeleteHandsWithCard()
    {
        ...
        HandsRBT testRBT = new HandsRBT();
        Hands myHandsArray[] = new Hands[5];        
        myHandsArray[0] = new Hands(new Card(6, 'S'), new Card(3, 'D'), new Card(6, 'C'), new Card(2, 'H'), new Card(3, 'H'));
        myHandsArray[1] = new Hands(new Card(6, 'D'), new Card(6, 'S'), new Card(3, 'H'), new Card(6, 'C'), new Card(2, 'H'));
        myHandsArray[2] = new Hands(new Card(3, 'H'), new Card(5, 'D'), new Card(4, 'C'), new Card(2, 'H'), new Card(2, 'S'));
        myHandsArray[3] = new Hands(new Card(8, 'S'), new Card(8, 'D'), new Card(8, 'C'), new Card(8, 'H'), new Card(7, 'H'));
        myHandsArray[4] = new Hands(new Card(12, 'S'), new Card(11, 'S'), new Card(13, 'S'), new Card(14, 'S'), new Card(10, 'S'));
        testRBT.insert(myHandsArray[0]);
        testRBT.insert(myHandsArray[1]);
        ...
        testRBT.deleteHandsWithCard(new Card(2, 'H'));
